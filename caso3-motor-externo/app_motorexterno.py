...
# Datos de conexión al motor. solo se cambia DB_HOST por el endpoint de
# la base remota; el resto del codigo no cambia comparado con el caso 2
DB_HOST = 'iot-rds.curlniejncze.us-east-1.rds.amazonaws.com'
DB_NAME = 'data'
DB_USER = 'iot'
DB_PASS = 'iot123'
